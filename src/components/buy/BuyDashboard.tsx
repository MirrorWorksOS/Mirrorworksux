  ...
  return (
    <ModuleDashboard title="Buy" tabs={buyTabs} activeTab={activeTab} onTabChange={setActiveTab}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            ...
            <p className=" text-2xl font-semibold text-[var(--mw-mirage)]">${kpiData.openPOs.value.toLocaleString()}</p>
          </Card>
        </motion.div>
        ...
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            ...
            <p className=" text-2xl font-semibold text-[var(--mw-mirage)]">{kpiData.pendingRequisitions.count}</p>
        ...
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            ...
            <p className=" text-2xl font-semibold text-[var(--mw-error)]">${kpiData.overdueDeliveries.value.toLocaleString()}</p>
        ...
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            ...
            <p className=" text-2xl font-semibold text-[var(--mw-mirage)]">{kpiData.avgLeadTime.days} days</p>
        ...
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            ...
            <p className=" text-2xl font-semibold text-[var(--mw-mirage)]">${kpiData.spendThisMonth.value.toLocaleString()}</p>
            <div className="mt-3">
        ...
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            ...
            <p className=" text-2xl font-semibold text-[var(--mw-mirage)]">${kpiData.pendingBills.value.toLocaleString()}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            <h3 className="text-base font-semibold text-[var(--mw-mirage)] mb-4">Spend by Category</h3>
        ...
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            <h3 className="text-base font-semibold text-[var(--mw-mirage)] mb-4">Supplier Performance (On-Time %)</h3>
            <ResponsiveContainer width="100%" height={200}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-base font-semibold text-[var(--mw-mirage)]">Approval Queue</h3>
        ...
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-base font-semibold text-[var(--mw-mirage)]">Goods Awaiting Receipt</h3>
        ...
        <motion.div variants={staggerItem}>
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-base font-semibold text-[var(--mw-mirage)]">Bills Needing Matching</h3>
