...
const getPriorityBadge = (priority: Priority) => {
  switch (priority) {
    case 'urgent': return { bg: 'bg-[#FEE2E2]', text: 'text-[#EF4444]', label: 'Urgent' };
    case 'high': return { bg: 'bg-[#FFF4CC]', text: 'text-[#805900]', label: 'High' };
    case 'medium': return { bg: 'bg-[#DBEAFE]', text: 'text-[#0A7AFF]', label: 'Medium' };
              ...
              <div className="bg-[#FAFAFA] rounded-lg p-4">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-['Geist:SemiBold',sans-serif] text-[14px] font-semibold text-[#0A0A0A]">{stage.label}</h3>
                ...
                <div className="text-xs text-[#737373] mb-3 font-['Roboto_Mono',monospace]">
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-1 text-xs text-[#0A0A0A]">
                            ...
                            <span className="font-['Roboto_Mono',monospace] font-semibold">${opp.value.toLocaleString()}</span>
                          </div>
