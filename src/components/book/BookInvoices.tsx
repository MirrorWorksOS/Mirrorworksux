...
const statusConfig: Record<InvoiceStatus, { label: string; className: string }> = {
  ...
  paid: { label: 'Paid', className: 'bg-[#E3FCEF] text-[#36B37E]' },
        ...
        <div className="bg-white border border-[#E5E5E5] rounded-lg overflow-hidden">
          <table className="w-full">
            <thead className="bg-[#F5F5F5] border-b border-[#E5E5E5]">
              <tr>
                <th className="text-left px-4 py-3 font-['Geist:Medium',sans-serif] text-[13px] font-medium text-[#0A0A0A]">
                  Invoice #
                </th>
                <th className="text-left px-4 py-3 font-['Geist:Medium',sans-serif] text-[13px] font-medium text-[#0A0A0A]">
                  Customer
                ...
                <th className="text-center px-4 py-3 font-['Geist:Medium',sans-serif] text-[13px] font-medium text-[#0A0A0A]">
                  Actions
                </th>
              </tr>
            </thead>
                ...
                >
                  <td className="px-4 py-3">
                    <div className="flex flex-col">
                      <span className="font-['JetBrains_Mono',monospace] text-[13px] text-[#0A0A0A] font-medium">
                        {invoice.id}
                      </span>
                  ...
                  <td className="px-4 py-3 font-['Roboto_Mono',monospace] text-[13px] text-[#0A0A0A] font-medium">
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={cn(
                        ...
                        invoice.balanceDue === 0 ? 'text-[#36B37E]' : 'text-[#0A0A0A]'
                      )}
                    >
          ...
          {filteredInvoices.length === 0 && (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="font-['Geist:Medium',sans-serif] text-[14px] font-medium text-[#737373]">
                No invoices found
              </p>
              <p className="font-['Geist:Regular',sans-serif] text-[13px] text-[#737373] mt-1">
