  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <ModuleInfoCallout
        ...
        description="This module will provide a drag-and-drop canvas interface for designing factory floor layouts, positioning machines, defining work centers, and planning material flow paths. Implementation requires HTML5 Canvas or similar library (e.g., Konva, Fabric.js)."
      />
