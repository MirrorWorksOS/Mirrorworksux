    ...
    <motion.div initial="initial" animate="animate" variants={animationVariants.stagger} className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <motion.div variants={animationVariants.listItem} className="bg-white border border-[var(--border)] rounded-2xl p-6">
          ...
          <p className=" text-[24px] font-semibold text-[#1A2732]">{systemHealth.totalUsers}</p>
          <p className="text-[12px] text-[#737373] mt-2">{systemHealth.activeUsers} active</p>
        </motion.div>

        <motion.div variants={animationVariants.listItem} className="bg-white border border-[var(--border)] rounded-2xl p-6">
          <div className="w-10 h-10 bg-[#1A2732] rounded-lg flex items-center justify-center mb-4">
            <Database className="w-5 h-5 text-[#FFCF4B]" />
          </div>
          <h3 className="text-[13px] text-[#737373] mb-1">Products</h3>
          <p className=" text-[24px] font-semibold text-[#1A2732]">{systemHealth.totalProducts}</p>
        </motion.div>
        ...
        <motion.div variants={animationVariants.listItem} className="bg-white border border-[var(--border)] rounded-2xl p-6">
          ...
          <p className=" text-[24px] font-semibold text-[#1A2732]">{systemHealth.totalMachines}</p>
        </motion.div>

        <motion.div variants={animationVariants.listItem} className="bg-white border border-[var(--border)] rounded-2xl p-6">
          <div className="w-10 h-10 bg-[#1A2732] rounded-lg flex items-center justify-center mb-4">
            <Shield className="w-5 h-5 text-[#FFCF4B]" />
          </div>
          <h3 className="text-[13px] text-[#737373] mb-1">Suppliers</h3>
          <p className=" text-[24px] font-semibold text-[#1A2732]">{systemHealth.totalSuppliers}</p>
        </motion.div>
        ...
        <motion.div variants={animationVariants.listItem} className="bg-white border border-[var(--border)] rounded-2xl p-6">
          ...
          <p className=" text-[24px] font-semibold text-[#EF4444]">{systemHealth.openIssues}</p>
        </motion.div>
        ...
        <motion.div variants={animationVariants.listItem} className="bg-white border border-[var(--border)] rounded-2xl p-6">
          ...
          <Badge className="bg-[#1A2732] text-[#FFCF4B] border-0 text-base px-3 py-1">Healthy</Badge>
        </motion.div>
      </div>

      <Card className="bg-[#FFCF4B] border-2 border-[#2C2C2C] rounded-2xl p-6">
        <h3 className="text-[16px] font-semibold text-[#2C2C2C] mb-2">Admin Control Panel</h3>
