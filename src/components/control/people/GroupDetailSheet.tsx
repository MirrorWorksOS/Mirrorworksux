    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader className="text-left">
          <SheetTitle className="text-2xl font-bold text-[#0A0A0A]">{group.name}</SheetTitle>
        </SheetHeader>
        <div className="mt-4 space-y-5">
          <div className="rounded-2xl border border-[#E5E5E5] bg-[#F8F7F4] p-5">
          ...
          <div className="rounded-2xl border border-[#E5E5E5] bg-white p-5">
            ...
            <div className="space-y-2">
              {members.map(member => (
                <div key={member.id} className="flex items-center gap-3 rounded-xl bg-[#F8F7F4] p-2">
                  ...
                  <div>
                    <p className="text-sm text-[#0A0A0A]">{member.name}</p>
