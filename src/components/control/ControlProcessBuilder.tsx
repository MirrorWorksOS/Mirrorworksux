  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl tracking-tight text-foreground">Process builder</h1>
        <Button className="h-12 min-h-[48px] rounded-[var(--shape-lg)] bg-[var(--mw-yellow-400)] text-primary-foreground hover:bg-[var(--mw-yellow-500)]">
      ...
      <Card className="rounded-[var(--shape-lg)] border border-[var(--neutral-200)] bg-card p-12 shadow-xs">
        <div className="text-center">
          <GitBranch className="mx-auto mb-4 h-16 w-16 text-[var(--neutral-500)]" />
          <h3 className="mb-2 text-xl font-medium text-foreground">Process builder</h3>
