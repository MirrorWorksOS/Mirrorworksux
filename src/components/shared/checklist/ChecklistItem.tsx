  ...
  return (
    ...
    >
      <Checkbox
        ...
        className="mt-1 size-5 shrink-0 rounded-xs data-[state=checked]:border-[var(--mw-yellow-400)] data-[state=checked]:bg-[var(--mw-yellow-400)] data-[state=checked]:text-primary-foreground"
      />
