...
- ✅ `tabular-nums` for financial figures and IDs
- ✅ M3 shape scale (16px cards, 12px buttons)
- ✅ Borders: #E5E5E5 (neutral-200)
- ✅ M3 elevation system (shadow-xs through shadow-xl)
- ✅ M3 motion tokens (250ms standard, ease-standard)
- ✅ Animated icons integration
- ✅ Motion.js stagger animations
- ✅ Colour-coded status (green/yellow/red thresholds)
