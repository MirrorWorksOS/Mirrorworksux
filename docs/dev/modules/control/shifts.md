# Developer stub — control/shifts.md

<!-- TODO: migrate developer-only content from docs/user/modules/control/shifts.md here. -->

This file is a placeholder created during the 2026-04-18 Control module migration. The
source document at `docs/user/modules/control/shifts.md` is a Mixed-classification doc (user
...
States) remain in `docs/user/modules/control/shifts.md` until a human editor does the split.
