# Developer stub — control/tooling.md

<!-- TODO: migrate developer-only content from docs/user/modules/control/tooling.md here. -->

This file is a placeholder created during the 2026-04-18 Control module migration. The
source document at `docs/user/modules/control/tooling.md` is a Mixed-classification doc (user
