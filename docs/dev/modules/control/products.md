# Developer stub — control/products.md

<!-- TODO: migrate developer-only content from docs/user/modules/control/products.md here. -->

This file is a placeholder created during the 2026-04-18 Control module migration. The
source document at `docs/user/modules/control/products.md` is a Mixed-classification doc (user
...
States) remain in `docs/user/modules/control/products.md` until a human editor does the split.
