  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-sm font-medium text-foreground">MirrorWorks Agent quote analysis</h3>
        <Badge className="bg-[var(--mw-yellow-50)] text-[var(--mw-yellow-600)] border-0 text-[10px] px-1.5 py-0">Agent</Badge>
      </div>
