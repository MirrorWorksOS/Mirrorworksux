  ...
  return (
    ...
    >
      <PageHeader
        ...
        actions={
          <>
            <button type="button" onClick={() => toast('Date range picker — coming soon')} className="flex h-14 items-center gap-2 rounded-full border border-[var(--border)] px-4 text-sm font-medium text-foreground transition-colors hover:bg-[var(--neutral-100)]">
