...
function ProductEditor() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-0px)] bg-background">
      {/* ── Toolbar ──────────────────────────────────────────────────────────── */}
      <div className="flex items-center gap-3 px-4 py-2.5 border-b border-[var(--neutral-200)] dark:border-[var(--border)] bg-card shrink-0">
        {/* Back */}
        <Button
          variant="ghost"
          size="icon"
      ...
      <DndProvider backend={HTML5Backend}>
        <div className="flex min-h-0 flex-1">
          ...
          <div
            className={cn(
              'flex min-h-0 shrink-0 flex-col border-l border-[var(--neutral-200)] bg-card transition-all duration-300 dark:border-[var(--border)]',
              showPreview ? 'min-w-[280px] flex-1 basis-0' : 'w-[min(100%,420px)]',
            )}
          >
            {showPreview ? (
              <div className="flex min-h-0 flex-1">
                <div className="flex min-h-0 min-w-0 flex-1 flex-col border-r border-[var(--neutral-200)] dark:border-[var(--border)]">
