...
export function DashboardManagementBar({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex h-full flex-col gap-4 rounded-xl border border-[var(--neutral-200)] bg-card p-5 shadow-[var(--card-shadow-rest)] transition-[box-shadow] duration-[var(--duration-medium1)] ease-[var(--ease-standard)] dark:border-[var(--border)]",
        className,
      )}
    >
