...
const PAGES: PageItem[] = [
  ...
  { label: 'Customer portal', path: '/sell/portal', section: 'Sell', icon: Globe, keywords: ['client', 'quotes', 'orders'] },
  ...
  { label: 'MRP suggestions', path: '/buy/mrp-suggestions', section: 'Buy', icon: ClipboardList, keywords: ['material', 'planning'] },
  { label: 'Planning grid', path: '/buy/planning-grid', section: 'Buy', icon: CalendarDays, keywords: ['purchase', 'timeline'] },
  { label: 'Vendor comparison', path: '/buy/vendor-comparison', section: 'Buy', icon: Users, keywords: ['suppliers', 'rfq'] },
  { label: 'Reorder rules', path: '/buy/reorder-rules', section: 'Buy', icon: ClipboardCheck, keywords: ['min max', 'stock'] },
  ...
  { label: 'MRP', path: '/plan/mrp', section: 'Plan', icon: ClipboardList, keywords: ['demand', 'bom'] },
  { label: 'Sheet calculator', path: '/plan/sheet-calculator', section: 'Plan', icon: BarChart3, keywords: ['yield', 'metal'] },
  { label: 'CAD import', path: '/plan/cad-import', section: 'Plan', icon: Upload, keywords: ['dxf', 'drawing'] },
  ...
  { label: 'Scan station', path: '/make/scan', section: 'Make', icon: ScanBarcode, keywords: ['barcode', 'shop floor'] },
  { label: 'Scrap analysis', path: '/make/scrap-analysis', section: 'Make', icon: BarChart3, keywords: ['defects', 'quality'] },
  { label: 'CAPA', path: '/make/capa', section: 'Make', icon: Shield, keywords: ['corrective action'] },
  { label: 'Job traveler', path: '/make/job-traveler/mo-001', section: 'Make', icon: FileText, keywords: ['packet', 'traveler'] },
  ...
  { label: 'Carrier rates', path: '/ship/carrier-rates', section: 'Ship', icon: Truck, keywords: ['freight', 'courier'] },
  { label: 'Scan to ship', path: '/ship/scan-to-ship', section: 'Ship', icon: ScanBarcode, keywords: ['dispatch', 'barcode'] },
  ...
  { label: 'WIP valuation', path: '/book/wip', section: 'Book', icon: Layers, keywords: ['work in progress'] },
  { label: 'Cost variance', path: '/book/cost-variance', section: 'Book', icon: TrendingUp, keywords: ['standard cost'] },
  ...
  { label: 'Product Studio', path: '/plan/product-studio', section: 'Control', icon: Boxes, keywords: ['configurator', 'cpq', 'variants', 'plan'] },
  ...
  { label: 'Documents', path: '/control/documents', section: 'Control', icon: BookOpen, keywords: ['controlled docs'] },
...
function getRecentItems(): RecentItem[] {
  return readStorageJson<RecentItem[]>(RECENT_KEY, []);
}

function addRecentItem(item: RecentItem) {
  const items = getRecentItems().filter((r) => r.path !== item.path);
  items.unshift(item);
  writeStorageJson(RECENT_KEY, items.slice(0, MAX_RECENT));
}
...
export function CommandPalette({ open, onOpenChange, initialQuery = '' }: CommandPaletteProps) {
  ...
  const ACTIONS: ActionItem[] = useMemo(() => [
    ...
    { label: 'New Job', icon: Briefcase, section: 'Plan', description: 'Create production job', roles: ['production', 'admin'], action: () => navigate('/plan/jobs/new') },
    { label: 'New Manufacturing Order', icon: ClipboardList, section: 'Make', description: 'Create MO', shortcut: '⌘M', roles: ['production', 'admin'], action: () => navigate('/make/manufacturing-orders/new') },
    ...
    { label: 'Compose Email', icon: Mail, section: 'General', description: 'Send an email', action: () => {
        // TODO(backend): mail.compose()
