    ...
    <div className={cn("space-y-5", className)}>
      <div className="flex flex-col gap-2 pb-4 text-left">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className={dashboardSectionTitleClass}>MirrorWorks Agent</span>
        </div>
        <p className={dashboardSectionSubtitleClass}>
          Search modules, review recommendations, or jump to a record. Results open in the command palette
          (⌘K).
        </p>
      </div>
