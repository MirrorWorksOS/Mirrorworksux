  ...
  book: [
    {
      ...
      title: "3 invoices ready to send",
      body: "Three completed jobs (TechCorp, AeroSpace, Pacific Fab) have signed PODs and pricing locked — total $24.6K. Sending today brings cash forward by ~9 days on average.",
      tag: "Invoicing",
      tagColor: "bg-[var(--mw-yellow-400)]/15 text-foreground",
      timestamp: "12 min ago",
      actionLabel: "Send invoices",
      actionPath: "/book/invoices",
    },
    {
      id: "book-2",
      icon: <AlertTriangle className="h-4 w-4 text-[var(--mw-error)]" />,
      title: "$18.5K across 3 overdue invoices",
      body: "TechCorp Industries (14 days), AeroSpace Ltd (7 days), and a Steel Suppliers Co bill (3 days) are past terms. A reminder today historically lifts on-time payment by 34%.",
      tag: "AR risk",
      tagColor: "bg-[var(--mw-error)]/15 text-[var(--mw-error)]",
      timestamp: "45 min ago",
    ...
    {
      id: "book-3",
      icon: <Receipt className="h-4 w-4 text-[var(--mw-info)]" />,
      title: "2 expenses awaiting your approval",
      body: "Grinding discs (EXP-2026-0142, $1,250) and a site-visit reimbursement (EXP-2026-0143, $350) are sitting in the queue. Both are inside your normal approval threshold.",
      tag: "Approvals",
      tagColor: "bg-[var(--mw-info)]/15 text-[var(--mw-info)]",
      timestamp: "1h ago",
      actionLabel: "Open queue",
      actionPath: "/book/expenses",
    },
  ],
  buy: [
    {
