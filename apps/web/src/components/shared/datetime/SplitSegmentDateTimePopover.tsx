    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-expanded={open}
          className={cn(
            "group h-10 min-h-0 w-auto shrink-0 rounded-l-none rounded-r-md border-l-0 bg-card px-2.5 font-normal hover:bg-[var(--neutral-50)] sm:h-12 sm:min-h-[48px] sm:px-3",
