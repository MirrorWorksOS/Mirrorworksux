...
const NODE_PALETTE = [
  ...
  { kind: 'ai',           label: 'Agent action',   bg: 'bg-[var(--mw-purple)]',    icon: Sparkles    },
  ...
  return (
    <div className="w-[300px] flex-shrink-0 border-l border-[var(--border)] bg-card flex flex-col overflow-hidden">
      ...
      <div className="p-4 border-t border-[var(--border)] flex-shrink-0">
        <AIInsightCard title="Workflow improvement" className="text-xs">
          {node.kind === 'condition'
...
export function ControlWorkflowDesigner() {
  ...
  const handleGenerate = () => {
    ...
    setTimeout(() => {
      ...
      setAiPrompt('');
      toast.success('Workflow generated by MirrorWorks Agent');
    }, 2200);
  };
        ...
        <div className="p-4 border-b border-[var(--border)] space-y-3 flex-shrink-0">
          ...
          <div className="bg-[var(--mw-purple-50)] border border-[var(--mw-purple)]/25 rounded-[var(--shape-lg)] p-3">
            ...
            <Textarea
              ...
              rows={2}
              placeholder="Describe the workflow you want MirrorWorks Agent to build..."
              value={aiPrompt}
        ...
        {hasCanvasData ? (
          ...
          <div className="flex-1 flex items-center justify-center bg-[var(--neutral-100)]">
            <div className="text-center space-y-3">
              ...
              <p className="text-xs text-[var(--neutral-500)]">Use MirrorWorks Agent or drag nodes from the palette to build this workflow.</p>
            </div>
          </div>
        )}
      </div>
