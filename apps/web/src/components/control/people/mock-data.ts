...
export const mockGroups: Group[] = [
  ...
  { id: 'g-make-office', module: 'make', name: 'Office', description: 'Production leads with read access', isDefault: true, members: ['5', '2'], permissions: permissions({ 'documents.scope': 'all', 'workorders.scope': 'all', 'timers.scope': 'all', 'reports.access': true }) },
