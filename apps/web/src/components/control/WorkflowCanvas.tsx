...
const JOB_ARRIVAL_NODES: WFNode[] = [
  ...
  {
    id: 'ai-analyse', kind: 'ai', title: 'Agent: Analyse & prioritise', icon: Sparkles,
    x: 360, y: 140, h: 72,
...
const PO_APPROVAL_NODES: WFNode[] = [
  ...
  {
    id: 'po-ai-review', kind: 'ai', title: 'Agent: Review PO details', icon: Sparkles,
    x: 360, y: 120, h: 72,
...
const QC_ALERT_NODES: WFNode[] = [
  ...
  {
    id: 'qc-ai-classify', kind: 'ai', title: 'Agent: Classify defect severity', icon: Sparkles,
    x: 360, y: 120, h: 80,
