...
export const SUB_ITEM_META: Record<string, SubItemMeta> = {
  ...
  '/plan/nesting-studio': { icon: LayoutGrid, description: 'Multi-part nesting workspace' },
  '/plan/nesting-queue': { icon: Layers, description: 'Cut-step demand waiting for a programmer' },
  '/plan/nests': { icon: GanttChart, description: 'Nests across draft → done' },
  '/plan/mrp': { icon: FileSpreadsheet, description: 'Material requirements planning' },
  '/plan/sheet-calculator': { icon: Calculator, description: 'Single-part yield calculator (legacy)' },
  ...
  '/control/operations': { icon: Layers, description: 'Standard operations library' },
  '/control/routes': { icon: RouteIcon, description: 'Reusable operation sequences' },
