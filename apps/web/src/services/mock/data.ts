...
export const products: Product[] = [
  { id: 'prod-001', partNumber: 'BKT-001', description: 'Mounting Bracket 90° — Mild Steel', material: 'Mild Steel 3mm', unitPrice: 24.50, weightKg: 0.85, category: 'Brackets', isActive: true, imageUrl: '/products/bracket-90.svg',
    geometry: { bboxMm: { widthMm: 150, heightMm: 100 }, thicknessMm: 3, grade: '250', dxfAssetId: 'dxf-001', allowRotation: true, rotationStepsDeg: [0, 90, 180, 270], grainSensitive: false } },
  { id: 'prod-002', partNumber: 'PLT-042', description: 'Base Plate 200×200 — Stainless 304', material: 'Stainless 304 5mm', unitPrice: 67.00, weightKg: 2.10, category: 'Plates', isActive: true, imageUrl: '/products/base-plate.svg',
    geometry: { bboxMm: { widthMm: 200, heightMm: 200 }, thicknessMm: 5, grade: '304', dxfAssetId: 'dxf-002', allowRotation: true, rotationStepsDeg: [0, 90], grainSensitive: false } },
  ...
  { id: 'prod-004', partNumber: 'SRC-100', description: 'Server Rack Chassis 42U', material: 'Cold Rolled Steel 1.6mm', unitPrice: 1250.00, weightKg: 48.0, category: 'Racks', isActive: true, imageUrl: '/products/server-rack.svg',
    geometry: { bboxMm: { widthMm: 600, heightMm: 480 }, thicknessMm: 1.6, grade: 'CR1', dxfAssetId: 'dxf-003', allowRotation: true, rotationStepsDeg: [0, 180], grainSensitive: true } },
  { id: 'prod-005', partNumber: 'CTR-008', description: 'Cable Tray Support 600mm', material: 'Galvanised Steel 2mm', unitPrice: 38.00, weightKg: 1.20, category: 'Cable Management', isActive: true, imageUrl: '/products/cable-tray.svg',
    geometry: { bboxMm: { widthMm: 600, heightMm: 80 }, thicknessMm: 2, grade: 'Z275', dxfAssetId: 'dxf-004', allowRotation: true, rotationStepsDeg: [0, 90, 180, 270], grainSensitive: false } },
  ...
  { id: 'prod-007', partNumber: 'AEP-050', description: 'Aluminium Enclosure Panel — IP65', material: 'Aluminium 5052 2mm', unitPrice: 145.00, weightKg: 2.80, category: 'Enclosures', isActive: true, imageUrl: '/products/enclosure-panel.svg',
    geometry: { bboxMm: { widthMm: 400, heightMm: 300 }, thicknessMm: 2, grade: '5052', dxfAssetId: 'dxf-005', allowRotation: true, rotationStepsDeg: [0, 90, 180, 270], grainSensitive: true } },
  ...
  { id: 'prod-010', partNumber: 'CPE-030', description: 'Control Panel Enclosure 600×800', material: 'Mild Steel 1.6mm + Powder Coat', unitPrice: 420.00, weightKg: 15.0, category: 'Enclosures', isActive: true, imageUrl: '/products/control-panel.svg',
    geometry: { bboxMm: { widthMm: 800, heightMm: 600 }, thicknessMm: 1.6, grade: '250', dxfAssetId: 'dxf-006', allowRotation: true, rotationStepsDeg: [0, 180], grainSensitive: false } },
];
...
export const sheetStocks: SheetStock[] = [
  { id: 'stk-001', sku: 'MS-1.6-2400x1200', material: 'Mild Steel', grade: '250', thicknessMm: 1.6,
    ...
    costPerSheetAud: 78, weightKg: 36.2, grainDirection: 'with_length', isRemnant: false, status: 'available' },
  { id: 'stk-002', sku: 'MS-3-2400x1200', material: 'Mild Steel', grade: '250', thicknessMm: 3,
    ...
    costPerSheetAud: 142, weightKg: 67.8, grainDirection: 'with_length', isRemnant: false, status: 'available' },
  { id: 'stk-003', sku: 'MS-6-3000x1500', material: 'Mild Steel', grade: '350', thicknessMm: 6,
    ...
    costPerSheetAud: 480, weightKg: 211.9, grainDirection: 'with_length', isRemnant: false, status: 'available' },
  ...
  { id: 'stk-007', sku: 'GZ-2-2400x1200', material: 'Galvanised Steel', grade: 'Z275', thicknessMm: 2,
    ...
    costPerSheetAud: 96, weightKg: 45.2, grainDirection: 'with_length', isRemnant: false, status: 'available' },
  { id: 'stk-008', sku: 'REM-MS-3-1480x1200', material: 'Mild Steel', grade: '250', thicknessMm: 3,
    ...
    costPerSheetAud: 0, weightKg: 41.8, grainDirection: 'with_length', isRemnant: true, parentSheetStockId: 'stk-002', status: 'available' },
...
export const machineNestingConfigs: MachineNestingConfig[] = [
  { id: 'mnc-001', machineId: 'mach-001', material: 'Mild Steel', thicknessMm: 1.6,
    ...
    allowCommonCut: true, leadInRule: 'corner', gasType: 'N2', pierceTimeSec: 0.4, cutSpeedMmPerMin: 8500 },
  { id: 'mnc-002', machineId: 'mach-001', material: 'Mild Steel', thicknessMm: 3,
    ...
    allowCommonCut: true, leadInRule: 'corner', gasType: 'O2', pierceTimeSec: 1.2, cutSpeedMmPerMin: 4200 },
  { id: 'mnc-003', machineId: 'mach-001', material: 'Stainless 304', thicknessMm: 3,
    ...
    allowCommonCut: false, leadInRule: 'midpoint', gasType: 'N2', pierceTimeSec: 1.4, cutSpeedMmPerMin: 3200 },
  { id: 'mnc-004', machineId: 'mach-001', material: 'Stainless 304', thicknessMm: 5,
    ...
    allowCommonCut: false, leadInRule: 'midpoint', gasType: 'N2', pierceTimeSec: 2.5, cutSpeedMmPerMin: 1700 },
  { id: 'mnc-005', machineId: 'mach-001', material: 'Aluminium 5052', thicknessMm: 2,
    ...
    allowCommonCut: false, leadInRule: 'auto', gasType: 'N2', pierceTimeSec: 0.6, cutSpeedMmPerMin: 6500 },
  { id: 'mnc-006', machineId: 'mach-006', material: 'Mild Steel', thicknessMm: 3,
    kerfMm: 0.2, partGapMm: 6, edgeGapMm: 10, allowRotation: true, rotationStepsDeg: [0, 90, 180, 270],
    allowCommonCut: true, leadInRule: 'corner', gasType: 'O2', pierceTimeSec: 1.4, cutSpeedMmPerMin: 3800 },
  { id: 'mnc-007', machineId: 'mach-007', material: 'Mild Steel', thicknessMm: 10,
    ...
    allowCommonCut: false, leadInRule: 'pierce_only', gasType: 'O2', pierceTimeSec: 1.8, cutSpeedMmPerMin: 2400 },
];
