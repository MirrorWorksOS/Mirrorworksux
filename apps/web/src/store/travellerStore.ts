...
const initialTravellers: TravellerPacket[] = [
  {
    id: 'traveller-001',
    travellerNumber: 'TRV-2026-0001',
    jobRef: 'JOB-2026-0012',
    workOrderRef: 'WO-2026-0001',
    partName: 'Server Rack Chassis',
    drawingNumber: 'DWG-SRC-042U',
    drawingRevision: 'Rev D',
    quantityToMake: 8,
    currentOperation: 'Laser cut - Panel Set',
    routeOperationStrip: ['Laser', 'Deburr', 'Bend', 'Weld', 'Powder Coat', 'Final QC'],
    workstation: 'Laser Cell 1',
    workCentre: 'Cutting',
    linkedFiles: {
      drawing: 'DWG-SRC-042U-RevD.pdf',
      nc: 'NC-SRC-042U-LASER.ncx',
      instructions: 'WI-SRC-042U-ASSY.pdf',
      qc: 'QC-SRC-042U-INSPECT.pdf',
    },
    status: 'ready',
    checklist: {
